...
import app_usercenter.urls
import toexcel.urls
import app_website.urls
...
urlpatterns = [
    ...
    url(r'^%s/usercenter/' % APP_NAME, include(app_usercenter.urls)),
    url(r'^%s/toexcel/' % APP_NAME, include(toexcel.urls)),
    url(r'^%s/website/' % APP_NAME, include(app_website.urls)),
